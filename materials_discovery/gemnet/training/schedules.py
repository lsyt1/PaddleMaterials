...
# class LinearWarmupExponentialDecay(paddle.optimizer.lr.LambdaDecay):
...
#         staircase=False, last_step=-1, verbose=False):
#         assert decay_rate <= 1
#         if warmup_steps == 0:
#             warmup_steps = 1
...
#             return warmup * decay
#         super().__init__(optimizer, lr_lambda, last_epoch=last_step,
#             verbose=verbose)
...
class LinearWarmupExponentialDecay(paddle.optimizer.lr.LambdaDecay):
    ...
    def __init__(
        ...
        super().__init__(
            learning_rate, lr_lambda, last_epoch=last_step, verbose=verbose
        )
